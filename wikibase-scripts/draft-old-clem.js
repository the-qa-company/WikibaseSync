                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data_length < 1) {
                                        ...
                                        if ($('.wikibase-snakview-property input').siblings('.mez-appended-button').length === 0) {
                                                $("<button class='mez-appended-button' onclick='cloneAction(this)'>Clone</button>").insertAfter($('.wikibase-snakview-property input'));
                                            }
